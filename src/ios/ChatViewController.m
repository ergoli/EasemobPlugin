...
- (void)_setupBarButtonItem
{
    ...
    [backButton setImage:[UIImage imageNamed:@"btn_back_black"] forState:UIControlStateNormal];
    ...
    [detailButton setTitleColor:[Utils colorWithHexString:@"#252729"] forState:UIControlStateNormal];
